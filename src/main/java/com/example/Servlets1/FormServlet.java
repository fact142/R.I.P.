        ...
        class Form{
            private static String makeForm(HttpServletRequest request) {
                return "<html><head>"
                        ...
                        +"</td></tr><tr><td valign=\"top\">"
                        +"Your last phone  number: </td>  <td valign=\"top\">"
                        +"<input type=\"text\" name=\"phone\" size=\"20\">"
                        +"</td></tr><tr><td valign=\"top\">"
                        +"Your email: </td>  <td valign=\"top\">"
                        +"<input type=\"text\" name=\"email\" size=\"20\">"
                        +"</td></tr><tr><td valign=\"top\">"
                        +"<input type=\"submit\" name=\"button\" value=\"Submit Info(left)\">"
                        +"<input type=\"submit\" name=\"button\" value=\"Submit Info(right)\"></td></tr>"
                        +"</table></form>"
                        +"</body></html>";
            }
        }
